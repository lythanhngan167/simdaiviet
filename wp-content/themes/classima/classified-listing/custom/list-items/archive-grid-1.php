...
<div class="swiper-slide"> 
	...
	<?php if($type['label'] == 'Sim Viettel'){
		echo "listing-sim-viettel";
	}
	elseif($type['label'] == 'Sim Vinaphone'){
		echo "listing-sim-vinaphone";
	}
	elseif($type['label'] == 'Sim Mobifone'){
		echo "listing-sim-mobifone";
	}
	elseif($type['label'] == 'Sim Vietnamobile'){
		echo "listing-sim-vietnamobile";
	}
	elseif($type['label'] == 'Sim Gmobile'){
		echo "listing-sim-gmobile";
	}
	else{
		echo "listing-sim-itelecom";
	} ?> 
	">
        <div class="rtin-item">
            ...
            <div class="rtin-content">
				...
				<?php if ( $display['cat'] ): ?>
                    <a class="rtin-cat"
                       href="<?php echo esc_url(  the_permalink()); ?>"><?php echo esc_html( $category->name ); ?></a>
				<?php endif; ?>
